...
const LOCAL_USERS_KEY = 'strata_users';
const LOCAL_CURRENT_USER_KEY = 'strata_current_user';
const LOCAL_CONVERSATIONS_PREFIX = 'strata_conversations_';
